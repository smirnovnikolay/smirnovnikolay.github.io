 jQuery(function($){
  $(document).mouseup(function (e){ // событие клика по веб-документу
    ...
    //popup basket close
    var div = $(".stash__pop.active"); // тут указываем ID элемента
    ...
    //popup option close
    var div = $(".popup-option__value.active"); // тут указываем ID элемента
    ...
    //menu close
    var div = $(".menu__wrapper.active .menu"); // тут указываем ID элемента
...
//
 ...
 $(function() {
    $('#phone1, #phone2, #phone3, #phone4').mask("+380 (999) 999-99-99");    
